...
class qualityLife(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for year_value in years:
            ...
            url = f"https://www.numbeo.com/crime/rankings_by_country.jsp?title={year_value}"
